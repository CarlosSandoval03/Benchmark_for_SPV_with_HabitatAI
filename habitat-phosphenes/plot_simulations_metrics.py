...
if __name__ == "__main__":
    ...
    folder_paths = [
        ...
        "train_E2E/train_NPT_RGB_E2E_2.8Msteps_2Envs_800spe_xavierWeights_lr=e-4_32spu_weightLossPPO=0.1_decoderWithRelu",
        "train_E2E/train_NPT_RGB_E2E_2.8Msteps_2Envs_800spe_xavierWeights_lr=e-4_32spu_weightLossPPO=0.9_decoderWithRelu",
        "train_E2E/train_NPT_RGB_E2E_2.8Msteps_2Envs_800spe_xavierWeights_lr=e-4_32spu_weightLossPPO=0.3_decoderWithRelu",
        "train_E2E/train_NPT_RGB_E2E_2.8Msteps_6Envs_800spe_xavierWeights_lr=2.5e-4_32spu_weightLossPPO=0.6_withJitteringIntensity",
        # "train_Baselines/train_NPT_GPSDepth_Original_2.8Msteps_8Envs",
        # "train_CVSegmentation/train_NPT_GPSRGB_Original_2.8Msteps_8Envs"
    ]
    ...
    file_labels = [
        ...
        "E2E_PPOcoeff=0.9",
        "E2E_PPOcoeff=0.3",
        "E2E_PPOcoeff=0.6_WithJittering",
    ...
    figure_names = [
        "./results/Experiment6/dtg_exp6.png",
        "./results/Experiment6/spl_exp6.png",
        "./results/Experiment6/reward_exp6.png",
        "./results/Experiment6/de_exp6.png"
    ] # 1 per metric of interest
    metrics_of_interest = ["metrics/distance_to_goal", "metrics/spl", "reward", "learner/dist_entropy", "learner/recon_loss", "learner/total_loss"] # eval_metrics/ or metrics/ or learner/recon_loss
    figure_titles = ["Distance to Goal", "SPL", "Reward", "Dist Entropy", "Reconstruction Loss", "Total Loss"] # 1 per figure (metric of interest)
